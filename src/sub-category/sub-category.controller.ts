...
export class SubCategoryController {
  ...
  @ApiBody({ type: [CreateSubcategoryDto], description: 'Array of subcategories to be created' })
  @ApiResponse({ status: 201, description: 'Subcategories created successfully' })
  @Post('/createMany')
